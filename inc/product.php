...
<div class="col-12 col-lg-4">
    ...
    <img src="../assets/img/apple-logo.png" class="card-img-top" alt="...">
    <div class="card-body">
...
<div class="col-12 col-lg-4">
    ...
    <img src="../assets/img/samsung-logo.png" class="card-img-top" alt="...">
    <div class="card-body">
...
<div class="col-12 col-lg-4">
    <div class="card box-shadow mx-auto my-5" style="width: 18rem;">
    <img src="../assets/img/watch-logo.png" class="card-img-top" alt="...">
    <div class="card-body">
